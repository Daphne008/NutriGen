      ...
      <CardHeader>
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <CardTitle>Patient Clinical Profile</CardTitle>
            <CardDescription>
              Click a highlighted vital to open pathology choices—nothing is selected until you check a box in the
              popup. Dietitian or patient can build the differential manually.
            </CardDescription>
          </div>
