...
export const PLATFORM_CAPABILITIES = [
  {
    ...
    description:
      "Choose one or more case themes on the Dashboard (e.g. Pediatric, Diabetic)."
  },
  {
  ...
  },
  {
    ...
    description:
      "Send your plan once it is complete; accuracy flags and dietary feedback will appear on the evaluation screen for personalized results."
  }
] as const;
...
export const CONTEXT_TITLES_STORAGE_KEY = (planId: number) => `nutrigen-context-titles-${planId}`;
