...
export const CATEGORY_HOVER: Record<string, string> = {
  pediatric: "Growth-focused nutrition and micronutrient balance.",
  diabetic: "Glycemic control and structured meal timing.",
  hypertension: "Blood-pressure-aware nutrition and sodium-conscious planning.",
  obese: "Calorie-aware plans with sustainable habits.",
  geriatric: "Protein adequacy and easy-to-prepare meals.",
  "severe-depression": "Mood-supportive meal rhythm and consistent nutrient coverage.",
  "below-poverty-line": "Cost-aware swaps and pantry-friendly planning."
};
